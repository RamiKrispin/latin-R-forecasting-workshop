---
title: "Forecasting with Linear Regression Models"
author: "Rami Krispin"
date: last-modified
format:
    html:
...
<figure>
 <img src="assets/latin_america_map.png" width="100%" style="max-width: 600px;"/>
 <figcaption style="font-style: italic; color: #666; margin-top: 10px;">Latin America 3D map (created with Midjourney)</figcaption>
</figure>
...
1. [**Data**](01_data.html) - Introduction to the datasets and time series objects
2. [**Time Series Decomposition**](02_time_series_decomposition.html) - Understanding trend, seasonal, and irregular components
3. [**Correlation Analysis**](03_correlation_analysis.html) - Analyzing autocorrelation and partial autocorrelation
4. [**Seasonal Analysis**](04_seasonal_analysis.html) - Deep dive into seasonal patterns
...
5. [**Modeling Trend**](05_modeling_trend.html) - Building linear and piecewise trend models
6. [**Modeling Seasonality**](06_modeling_seasonality.html) - Incorporating seasonal patterns and structural breaks
7. [**Probabilistic Forecast**](07_probabilistic_forecast.html) - Creating simulation-based forecasts with uncertainty quantification
...
**Registration:** [Eventbrite](https://www.eventbrite.cl/e/forecasting-with-regression-models-tickets-1955640717029)
